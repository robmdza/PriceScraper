...
for element in all_elements:
    ...
    shipping = element.find('p',
                            class_="ui-search-item__shipping ui-search-item__shipping--free shops__item-shipping-free").text
